...
I started by using my user interface design to build the basic outline of my app. I separated different sections into modules, so that I could work on them seprately without disrupting the rest of my app. I also used a index.css file to help format my app. At this stage, I have decided not to add any content to the individual sections, but focused on creating a template for the app. The code for this can be seen below.
...
After adding these individual modules to my app, I ran the program, resulting in the webpage shown below. I then decided to add css style to my app.
