...
| 2    | Connect to database (see [3.1](2.2.3-cycle-3-user-interface.md#3.1))                                                                                             | The back-end should be able to connect to mongoDB and output any data it recieves.                                                                           | The weather data was recieved from mongoDB and displayed in the back-end terminal.                                                                                                                                | Pass      |
| 3    | Display weather data on react app (see [3.3](2.2.3-cycle-3-user-interface.md#3.3))                                                                               | The front-end should recieve weather data from the back-end and display it on the react app in an easily accessible format.                                  | Previous weather data readings were displayed in the form of a log/history on a section of the app. This was in the form of a table instead of the origonal JSON format, so can be easily understood by the user. | Pass      |
| 4    | Make a basic user interface ([3.1](2.2.3-cycle-3-user-interface.md#3.1), [3.2](2.2.3-cycle-3-user-interface.md#3.2), [3.3](2.2.3-cycle-3-user-interface.md#3.3)) | The user interface should have seperate sections to display current readings (e.g. temperature, pressure, humidity), predicted weather forecasts and graphs. | The react app contained seperate sections for each reading taken by the weather station, as well as additional spaces for weather forecasting and monitoring. The UI is responsive to multiple sceen sizes.       | Pass      |
