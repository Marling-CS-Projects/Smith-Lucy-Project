...
The final aspect of setting up my app is connecting it to mongoDB, and displaying the data collected on my app. Firstly, I used the following code to connect to mongoDB. As expected, I received the message "Connected to MongoDB" without any errors in the terminal.
