...
* [ ] Setup a basic web app using react js
...
| 3.2 | Display sample data on the weather app, using my user interface design | In this part of the cycle, I will add the content to my weather app, using sample data.                                                                                                                          | The app should display the weather data clearly, including readings of temperature, humidity, pressure and air quality.                                                    |
| 3.3 | Formatting my user interface                                           | In this section, I am going to alter the format of my react app to ensure it is easy for a stakeholder to navigate.                                                                                              |                                                                                                                                                                            |
...
The final aspect of setting up my app is connecting it to mongoDB, and displaying the data collected on my app.&#x20;
...
Before I could start adding components to my react app, I needed to design an outline for the user interface. My graphical user interface must be easy for the user to navigate, and must include up-to-date information. However, in this section I am going to use some sample data to simulate what my weather application will look like.

### User interface design:

image here...

Now that I have a clear plan in mind for my user interface, I am going to start adding the different sections to my app



### 3.3

Improving the format and usability of my user interface (CSS).



### 3.4

Other components - e.g. graphs, user instructions
