...
Now that I have programmed the foundations of my solution, data collection and storage, in this cycle I will begin developing the user interface for my weather monitoring application. Once this stage is complete, I will then be able to move on to displaying the data I have collected, monitoring trends over time, and weather prediction.
...
| 3.3 | App functionality                         | In this section I will focus on adding essential components to my app, including the menu and weather history.                                                                                                    | The stakeholder should be able to navigate through to different sections of the app easily.                                                                                |
| 3.4 | Improving usability of the app            | In the final section of this cycle, I will adapt the user interface to make it more accessible and improve usability. E.g. making the app engaging, and making sure each section of the app is functional.        | All sections of the app should work correctly. The app should also be able to deal with errors, such as not connecting with the back-end.                                  |
...
| lastUpdate     | Integer Variable | Designed to store the time at which the app was last updated                         |
| temp           | Integer Variable | Designed to store the current temperature                                            |
...
In this section, I am going to set up the front-end of my app and display text on the app. Firstly, I created a react app and added the following code to the app.js file.
...
<figure><img src="../.gitbook/assets/Screenshot 2023-07-04 at 10.23.36.png" alt="" width="563"><figcaption></figcaption></figure>

#### Using node js as a back-end

The next stage of my project is to make a node.js back-end which can communicate with the main react app. The react app should be able to access and display data from the node backend. I added the code below to the server.js file. I used express to create a web server, which I will run on port 8000.
...
<figure><img src="../.gitbook/assets/Screenshot 2023-07-04 at 10.33.52.png" alt="" width="243"><figcaption></figcaption></figure>

The message was also displayed on the web server.

<figure><img src="../.gitbook/assets/Screenshot 2023-07-04 at 10.35.31.png" alt="" width="375"><figcaption></figcaption></figure>
...
<figure><img src="../.gitbook/assets/Screenshot 2023-07-04 at 10.55.55.png" alt="" width="563"><figcaption></figcaption></figure>

The react app was successfully able to access the back-end and display the text on the app as expected. This will be useful later in this cycle when I need to access weather data readings from mongoDB.

#### Collecting data from mongoDB

The final aspect of setting up my app is connecting it to mongoDB, and displaying the data collected on my app. I used the mongoose library for this. Firstly, I used the following code to connect to mongoDB. As expected, I received the message "Connected to MongoDB" without any errors in the terminal.
...
<figure><img src="../.gitbook/assets/Screenshot 2023-07-05 at 10.31.02.png" alt="" width="256"><figcaption></figcaption></figure>
...
<figure><img src="../.gitbook/assets/Screenshot 2023-07-05 at 11.55.19.png" alt="" width="563"><figcaption></figcaption></figure>

I realised that the issue was that await can only be used in an asynchronous function. After placing the code above in a separate function, I received the data that can be seen below.

<figure><img src="../.gitbook/assets/Screenshot 2023-07-05 at 11.57.55.png" alt="" width="563"><figcaption></figcaption></figure>
...
<figure><img src="../.gitbook/assets/Screenshot 2023-07-06 at 09.17.45.png" alt="" width="563"><figcaption></figcaption></figure>
...
<figure><img src="../.gitbook/assets/Screenshot 2023-07-20 at 09.27.25.png" alt="" width="563"><figcaption></figcaption></figure>
...
<figure><img src="../.gitbook/assets/Screenshot 2023-07-20 at 09.38.25.png" alt="" width="563"><figcaption></figcaption></figure>

<figure><img src="../.gitbook/assets/Screenshot 2023-07-20 at 09.38.40.png" alt="" width="563"><figcaption></figcaption></figure>

#### Making the app responsive

Now that I have built the foundations of my user interface, the next stage is to improve its performance. So that my app is accessible by a variety of devices, I am going to use two columns when the width of the screen is over 800px. Otherwise, I will use a single column. I added the following code to index.css.
...
<figure><img src="../.gitbook/assets/Screenshot 2023-07-20 at 09.50.17.png" alt="" width="563"><figcaption><p>Screen width greater than 800px</p></figcaption></figure>

<figure><img src="../.gitbook/assets/Screenshot 2023-07-20 at 09.54.23.png" alt="" width="563"><figcaption><p>Screen width less than 800px</p></figcaption></figure>

By changing the width of the device screen, I was successfully able to switch between the 1 and 2 column view. However, the minimum width of the screen had to be 520px for the app to be displayed correctly. Therefore, further adjustments must be made to make it accessible to other smaller devices, such as smartphones.
...
According to [https://accessally.com (2023)](../evaluation/reference-list.md), the smallest smartphone screen size that is actively in use is the iphone 5, which is 320 pixels wide. Therefore, I must alter the layout to ensure that the app is usable on this device. The image below shows how the altered program allows the app to respond to the size of the screen. This test has now passed.

<figure><img src="../.gitbook/assets/Screenshot 2023-07-23 at 22.53.41.png" alt="" width="159"><figcaption></figcaption></figure>

### 3.3

In this part of the cycle, I am going to focus on the other sections of my weather app. This will include a page for readings history, user instructions and the menu bar.
...
* **About page** -> This page will give the user some basic information about their weather station, including whether it is able to connect to the app, when weather data was last received and when it was first activated.
* **History page** -> This will allow the user to access the 'raw data' collected from by the weather station.&#x20;
* **Help page** -> This will contain all the user instructions. It will inform them both how to set up the weather station, and to make the best use of this app.

The code below was added below to the index.js file to create five separate routes for the app.
...
Now that I have created four extra pages, the user needs to be able to navigate between them. Therefore, I will focus on creating a menu bar that is both functional and responsive. The diagram below demonstrates how the navigation menu will appear on a wide screen.

<figure><img src="../.gitbook/assets/Screenshot 2023-08-14 at 10.52.20.png" alt="" width="563"><figcaption></figcaption></figure>

In a new MenuData.js file, I imported the icons from react icons for my user interface menu and exported the data for each menu item in the form of an array. The code for this can be seen below.&#x20;
...
<figure><img src="../.gitbook/assets/Screenshot 2023-08-14 at 10.53.33.png" alt="" width="563"><figcaption></figcaption></figure>

As can be seen above, I was successfully able to navigate between pages using the menu bar. I then added the following to index.css to improve its usability.
...
<figure><img src="../.gitbook/assets/Screenshot 2023-08-14 at 10.55.17.png" alt="" width="563"><figcaption><p>UI Design - About Page</p></figcaption></figure>

I created a template for the about page using the code below. As well as giving the user some basic information about the weather station, it will also inform the user whether the connection is successful, when data was last received and when the weather station was first activated. It also contains a link to the home page.
    ...
    return(
        <div className="aboutPage">
            <div className="pageContent">
                ...
                <br/>
                <p className="homeLink">To view the data collected by your weather station, <a onClick={() => {window.location.pathname = "/"}}>home</a></p>
                <br/>
            </div>
        </div>
    );
...
<figure><img src="../.gitbook/assets/Screenshot 2023-08-14 at 10.56.39.png" alt="" width="563"><figcaption></figcaption></figure>

### History of readings

<figure><img src="../.gitbook/assets/Screenshot 2023-08-14 at 10.57.30.png" alt="" width="563"><figcaption><p>UI Design - Weather History</p></figcaption></figure>
...
<figure><img src="../.gitbook/assets/Screenshot 2023-08-02 at 18.37.08.png" alt="" width="563"><figcaption></figcaption></figure>

As expected, this displayed all the readings from the database onto the page. However, this format is difficult for a user to understand, and contains the timestamp and id, which would not be useful to them in this form. To resolve this, I used the Date() function to convert the timestamp to a date and time. I then spit the timestamp and data values up in a basic table. The code for this can be seen below.
...
<figure><img src="../.gitbook/assets/Screenshot 2023-08-14 at 10.58.55.png" alt="" width="563"><figcaption></figcaption></figure>
...
<figure><img src="../.gitbook/assets/Screenshot 2023-08-14 at 11.00.19.png" alt="" width="563"><figcaption></figcaption></figure>

As expected, this produced a table containing all the data on the database.&#x20;

### User Instructions

The next page I am going to focus on is user instructions. This is vital to my app's usability, as it will inform the stakeholder how to set up the weather station and use the app.

<figure><img src="../.gitbook/assets/Screenshot 2023-08-14 at 11.01.45.png" alt=""><figcaption><p>UI Design - User Instructions</p></figcaption></figure>
...
<figure><img src="../.gitbook/assets/Screenshot 2023-08-14 at 11.03.15.png" alt="" width="563"><figcaption></figcaption></figure>

### 3.4

### Modifying my user interface design

In the final section of this cycle, I am going to focus on improving engagement and usability. As well as making sure the app is functional, this will also include adapting the visual components of the app so that it is easy to navigate. I decided to use a blue colour scheme throughout my app, as can be seen below.

<figure><img src="../.gitbook/assets/Screenshot 2023-08-14 at 11.04.21.png" alt="" width="563"><figcaption></figcaption></figure>

<figure><img src="../.gitbook/assets/Screenshot 2023-08-14 at 11.05.51.png" alt="" width="563"><figcaption></figcaption></figure>

### Weather history limits

While I currently only have a limited number of readings stored in the database, when the weather station is in use for long periods of time, the database will store much larger numbers of readings, which is too many to display in the weather history. Therefore, I will set the maximum number of log entries to 100.

To test this, I will start by limiting the readings to four. I added the following code to the back-end database.js file.

```javascript
const docs = await Weather.find().sort({_id: -1}).limit(4)
```

As expected, this resulted in only the four most recent readings being displayed.

<figure><img src="../.gitbook/assets/Screenshot 2023-08-14 at 11.06.42.png" alt="" width="175"><figcaption></figcaption></figure>

I then changed the .limit() method range to (100), limiting the number of readings to 100.

## Outcome

Throughout this cycle, I have designed and programmed a user interface that uses react as a front-end and node as a back-end. The app has four pages - a home page, about page, weather history page and a user instructions page. After working on the pages individually, I was able to make a navigation bar, allowing the user to switch between pages.&#x20;

One of the main challenges during this cycle was maintaining the responsive quality of my app when adding components, especially on the home and weather history pages. In future cycles, before displaying readings on the user interface, I will need to ensure that both the front-end and back-end update automatically.

### Testing

| Test | Instructions                                                                                                                                                     | What I expect                                                                                                                                                | What actually happens                                                                                                                                                                                             | Pass/Fail |
| ---- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------ | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------- |
| 1    | Setup basic app (see [3.1](2.2.3-cycle-3-user-interface.md#3.1), [3.2](2.2.3-cycle-3-user-interface.md#3.2))                                                     | The app should have a react.js front-end and a node.js back-end, which are able to connect with each other                                                   | The front-end and back-end successfully connected to each other.                                                                                                                                                  | Pass      |
| 2    | Connect to database (see [3.1](2.2.3-cycle-3-user-interface.md#3.1))                                                                                             | The back-end should be able to connect to mongoDB and output any data it receives.                                                                           | The weather data was received from mongoDB and displayed in the back-end terminal.                                                                                                                                | Pass      |
| 3    | Display weather data on react app (see [3.3](2.2.3-cycle-3-user-interface.md#3.3))                                                                               | The front-end should receive weather data from the back-end and display it on the react app in an easily accessible format.                                  | Previous weather data readings were displayed in the form of a log/history on a section of the app. This was in the form of a table instead of the original JSON format, so can be easily understood by the user. | Pass      |
| 4    | Make a basic user interface ([3.1](2.2.3-cycle-3-user-interface.md#3.1), [3.2](2.2.3-cycle-3-user-interface.md#3.2), [3.3](2.2.3-cycle-3-user-interface.md#3.3)) | The user interface should have separate sections to display current readings (e.g. temperature, pressure, humidity), predicted weather forecasts and graphs. | The react app contained separate sections for each reading taken by the weather station, as well as additional spaces for weather forecasting and monitoring. The UI is responsive to multiple sceen sizes.       | Pass      |
| 5    | Menu connecting multiple app pages ([3.3](2.2.3-cycle-3-user-interface.md#3.3))                                                                                  | The menu should connect the app to multiple routes - home, about the weather station, weather data log, user instructions and the about page.                | It is easy for the user to navigate the menu and switch between sections.                                                                                                                                         | Pass      |
| 6    | Ensuring the app is functional and error-tolerant ([3.4](2.2.3-cycle-3-user-interface.md#3.4))                                                                   | The app should be able to deal with any errors - such as missing data or being in the incorrect format.                                                      | After some editing and testing, I was able to prevent these errors from occuring.                                                                                                                                 | Pass      |
