...
| ---- | ------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------- | --------- |
| 4.1  | Adapt the app to automatically update its contents at regular intervals.              | When new data is recorded on the database, the app should be updated within 30 seconds.                                                        | The app successfully updated itself upon recieving new weather data.                                                                   | Pass      |
| 4.2  | Display basic readings                                                                | Readings should be displayed visually in a format that is easily accessible to the user.                                                       | Displayed temperature, dust concentration, air pressure and altitude on the user interface.                                            | Pass      |
| 4.3  | Use a progress bar to show the relative proportion of data (e.g. percentage humidity) | Readings for sound, light and humidity should be shown on a user interface and automatically update itself.                                    | The app correctly displayed readings for sound, light and humidity.                                                                    | Pass      |
| 4.4  | Air quality index                                                                     | The needle should change direction and point at the approproate air quality.                                                                   | I was successfully able to display air quality readings on a speedometer to represent changes in air quality.                          | Pass      |
| 4.5  | Tracking trends in weather data                                                       | In this section I will use line graphs, area graphs and bar charts to visualise trends in data.                                                | Successfully programmed charts to track trends in temperature, a bar chart comparing light and sound, humidity and dust concentration. | Pass      |
| 4.6  | About your weather station page                                                       | The app should display conecetion status, the time the last piece of weather data was recieved and when the weather station was first updated. | All the readings were correctly displayed on the app.                                                                                  | Pass      |
