...
| 4    | Air quality index (see [4.2](2.2.4-cycle-4-displaying-and-monitoring-weather-conditions.md#4.2))                                                                                | The needle should change direction and point at the approproate air quality.                                                                   | I was successfully able to display air quality readings on a speedometer to represent changes in air quality.                          | Pass      |
...
| 6    | About your weather station page (see [4.4](2.2.4-cycle-4-displaying-and-monitoring-weather-conditions.md#4.4))                                                                  | The app should display conecetion status, the time the last piece of weather data was recieved and when the weather station was first updated. | All the readings were correctly displayed on the app.                                                                                  | Pass      |
