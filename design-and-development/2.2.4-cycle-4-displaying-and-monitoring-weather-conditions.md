...
| interval           | Number           | Stores the interval in miliseconds between updates on the user interface                   |
| connection\_status | String Variable  | Stores either "ACTIVE" or "OFFLINE" based on whether data has been recieved within 2 hours |
        ...
        <div className="helpPage">
            ...
            <div className="pageContent">
                <div className="aboutAppText">
                    ...
                    <p className="helpText">This app connects directly with your weather station and allows you to monitor and track treds in your local environment.</p>
...
| ---- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------- | --------- |
| 4.1  | Adapt the app to automatically update its contents at regular intervals. (see [4.1](2.2.4-cycle-4-displaying-and-monitoring-weather-conditions.md#4.1))                         | When new data is recorded on the database, the app should be updated within 30 seconds.                                                        | The app successfully updated itself upon recieving new weather data.                                                                   | Pass      |
...
| 4.3  | Use a progress bar to show the relative proportion of data (e.g. percentage humidity) (see [4.3](2.2.4-cycle-4-displaying-and-monitoring-weather-conditions.md#4.3))            | Readings for sound, light and humidity should be shown on a user interface and automatically update itself.                                    | The app correctly displayed readings for sound, light and humidity.                                                                    | Pass      |
| 4.4  | Air quality index (see [4.2](2.2.4-cycle-4-displaying-and-monitoring-weather-conditions.md#4.2))                                                                                | The needle should change direction and point at the approproate air quality.                                                                   | I was successfully able to display air quality readings on a speedometer to represent changes in air quality.                          | Pass      |
| 4.5  | Tracking trends in weather data (see [4.3](2.2.4-cycle-4-displaying-and-monitoring-weather-conditions.md#4.3))                                                                  | In this section I will use line graphs, area graphs and bar charts to visualise trends in data.                                                | Successfully programmed charts to track trends in temperature, a bar chart comparing light and sound, humidity and dust concentration. | Pass      |
| 4.6  | About your weather station page (see [4.4](2.2.4-cycle-4-displaying-and-monitoring-weather-conditions.md#4.4))                                                                  | The app should display conecetion status, the time the last piece of weather data was recieved and when the weather station was first updated. | All the readings were correctly displayed on the app.                                                                                  | Pass      |
