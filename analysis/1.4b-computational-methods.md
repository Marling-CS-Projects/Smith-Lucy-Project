...
* Meanwhile, the forecasting aspect of the problem would be split into several sub-problems, including collecting the data, designing an algorithm to make the forecast and &#x20;
