...
<figure><img src="../.gitbook/assets/Screenshot 2023-10-12 at 12.00.40.png" alt="" width="563"><figcaption></figcaption></figure>

Similarly, Criterion 19 requires the user interface to be easy for the user to understand and interpret. +++++++++++++
...
Another crutial part of my success criteria is ensuring the user interface is easily understandable, and has a clear layout. The user interface provides all the instructions needed to use the weather system. Additionally, my use of a clear layout and colourful design has been met, as shown below.
